...
docker exec clab-bgp-R4 ping 192.168.10.2 -c 1
docker exec clab-bgp-R3 ping 192.168.10.2 -c 1
docker exec clab-bgp-R5 ping 192.168.30.2 -c 1
docker exec clab-bgp-R4 ping 192.168.30.2 -c 1
